...
* blogのように、記事があって、コメントをつけれるページを作りたい
  * 記事は他の人には編集してほしくない
  * コメントした人にはコメントの編集を許容したい
  * 匿名コメントも許容したい（この場合は編集不可）
  * コメントを非表示にできる人を作りたい
  * コメントを付けられないページも欲しい
* wikiのように誰でも編集出来るページも欲しい
* 管理者しか変更出来ないページも欲しい
* 特定の人だけに見せるページも欲しい
* treeの特定箇所以下だけ見せる・見せないを決めたい
* バージョンアップした際に、既存ページで出来たアクセスコントロールは出来るようにしたい（データ構造を変更したくない）
